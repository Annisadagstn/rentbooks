...
<html lang="en">
  ...
  <body>
    ...
    -->
<form method="POST" action="{{route('authLogin')}}" class="card py-4 px-4">
      @csrf
    <div class="container">
        <div class="content p-4">
            <center>  <h2> <strong>Form Login</strong></h2> </center>
                <body>
        </div>
    <div class="mb-3">
   ...
   <div class="mb-3">
        ...
        <button type="submit" class="btn btn-danger opacity-50">Submit</button>
